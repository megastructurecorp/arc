...
#
# This script sets up Forge and creates the naming-sprint channel.
...
curl -s -X POST http://127.0.0.1:6969/v1/channels \
  ...
  -d '{"name": "naming-sprint", "created_by": "operator", "metadata": {"purpose": "Find a new name for Forge"}}' | python3 -c "import sys,json; print(json.dumps(json.load(sys.stdin), indent=2))"
